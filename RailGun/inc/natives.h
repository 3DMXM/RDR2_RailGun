...
namespace ENTITY
{
	...
	static void SET_ENTITY_PROOFS(Entity entity, BOOL bulletProof, BOOL fireProof, bool a, bool b, bool c, bool d, bool e, bool f) { invoke<Void>(0xFAEE099C6F890BB8, entity, bulletProof, fireProof, a, b, c, d, e, f); }
...
namespace PED
{
	...
	static void _0x89F5E7ADECCCB49C(Any p0, char* p1) { invoke<Void>(0x89F5E7ADECCCB49C, p0, p1); }
	...
	static void _SET_PED_SCALE(Any p0, float p1) { invoke<Void>(0x25ACFC650B65C538, p0, p1); }
...
namespace AI
{
	...
	static void TASK_COMBAT_HATED_TARGETS(Any p0, float p1) { invoke<Void>(0x8182B561A29BD597, p0, p1); }
...
namespace AUDIO
{
	...
	static void STOP_SOUND_FRONTEND(const char* audioName, const char* audioRef) { invoke<Void>(0x0F2A2175734926D8, audioName, audioRef); } // 0x0F2A2175734926D8 b1207
	static void PLAY_SOUND_FROM_ENTITY(char* audioName, Entity entity, char* audioRef, BOOL p3, Any p4) { invoke<Void>(0x6FB1DA3CA9DA7D90, audioName, entity, audioRef, p3, p4); } // 0x6FB1DA3CA9DA7D90 b1207
...
namespace STREAMING
{
	...
	static void _REQUEST_NAMED_PTFX_ASSET(int assetName) { invoke<Void>(0xF2B2353BBC0D4E8F, assetName); }
	...
	static void SET_FOCUS_POS_AND_VEL(float x, float y, float z, float offsetX, float offsetY, float offsetZ) { invoke<Void>(0x25F6EF88664540E2, x, y, z, offsetX, offsetY, offsetZ); }
...
namespace UI
{
	...
	static void _0x5DD02A8318420DD7(Any p0, char* p1) { invoke<Void>(0x5DD02A8318420DD7, p0, p1); }
...
namespace STATS
{
	...
	static BOOL _0xA4DDF5DF95E65EEE(void* p0, Any p1, BOOL p2) { return invoke<BOOL>(0xA4DDF5DF95E65EEE, p0, p1, p2); }
